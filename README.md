...
## Снизу Readme от текущей сборки, читаем и выполняем команды для установки.
## Скачиваем изменения от ветки master, в дальнейшем в нее не выливаем свои изменения!!!
## Делаем свою ветку с помощью git checkout -b author-name(ваше имя на английском). Делаем пуш только в нее, это ваша рабочая ветка, ветка master только для сборки!
## Делаем коммиты как можно чаще, чтобы не косячили. коммиты называем так - author-name_что_сделали
## работаем через git bush, терминал не поддерживает команду запуска gulp
